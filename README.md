...
Zaawansowany skrypt do automatycznego zbierania danych o bezpośrednich spotkaniach (H2H) z Livesport.com dla wielu sportów drużynowych + **predykcje Forebet.com**!
...
### 🎯 Integracja Forebet! **[NOWOŚĆ v7.0]** 🆕
Automatyczne pobieranie **predykcji AI z Forebet.com** dla wszystkich sportów!
- 🤖 **Predykcje AI** - 1/X/2, prawdopodobieństwo, dokładny wynik
- 📊 **Over/Under** - predykcje O/U 2.5
- ⚽ **BTTS** - Both Teams To Score
- 🌍 **Wszystkie sporty** - football, volleyball, basketball, handball, rugby, hockey, tennis
- 🔄 **Cloudflare bypass** - automatyczne omijanie zabezpieczeń
- 📈 **H2H + AI w jednym** - pełna analiza meczów

**Przykład użycia:**
```bash
# H2H + Forebet predictions
python livesport_h2h_scraper.py --date 2025-11-17 --sports volleyball --use-forebet
```

**[Zobacz: FOREBET_QUICKSTART.md](FOREBET_QUICKSTART.md)**
...
### 🔄 Auto-Restart!
Chrome automatycznie restartuje się co 80 meczów - **zero crashów** nawet przy 1500+ meczów!

### 🚀 GitHub Actions CI/CD + Xvfb!
Pełna integracja z GitHub Actions - **Forebet działa w CI/CD z Xvfb!**
- ✅ **Multi-Python** - testy na Python 3.9-3.13
- 🖥️ **Xvfb** - virtual display dla Forebet w CI/CD
- 🧪 **Automatyczne testy** - przy każdym push/PR
- 🔒 **Security** - bandit, safety check
- 📊 **Graceful degradation** - działa z i bez Forebet

**[Zobacz: XVFB_SUCCESS.md](XVFB_SUCCESS.md) | [GITHUB_ACTIONS_GUIDE.md](GITHUB_ACTIONS_GUIDE.md)**
